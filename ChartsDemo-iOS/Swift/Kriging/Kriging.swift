...
public enum KrigingMode: Int16 {
    ...
    static var count: Int {
        return Int(KrigingMode.gauss.rawValue + 1)
    }
}

public enum KrigingError: Error {
    case none
...
public class Kriging  {
    ...
    func train(t: [Double], x: [Double], y: [Double], model: KrigingMode, sigma2: Double, alpha: Double) {
        self.t = t
        self.x = x
        self.y = y
...
//    private var Mode: KrigingMode = .exponential
...
//     **/
//    init(KrigingMode mode: KrigingMode, knownDimensions item: Int, values Z_s: [Double], knownPositions pos: [Double], c0: Double, c1: Double, a: Double) {
//        self.Mode = mode
//        self.Dim = item + 1
//        self.C0 = c0
//        self.C1 = c1
