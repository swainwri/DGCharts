...
class PolarDemoViewController: NSViewController, ChartViewDelegate {
...
//        }
    ...
    func setChartData() {
        ...
        set1.highlightCircleStrokeColor = NSUIColor.red
        ...
        set2.setColor(NSUIColor.orange)
        set2.fillColor = NSUIColor.orange
        set2.drawFilledEnabled = false
        set2.fillAlpha = 0.7
        set2.lineWidth = 2
        set2.drawCirclesEnabled = false
        set2.drawHighlightCircleEnabled = true
        set2.highlightCircleStrokeColor = NSUIColor.orange
